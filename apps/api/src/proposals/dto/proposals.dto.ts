...
export class CreateProposalDto {
  ...
  @ApiPropertyOptional({
    description:
      'Número manual del consecutivo (1-99999). Si se provee, la propuesta se crea con consecutiveSource=MANUAL. Debe ser estrictamente menor al próximo número automático del usuario y no estar tomado.',
    example: 1234,
    minimum: 1,
    maximum: 99999,
  })
...
export class UpdateScenarioItemDto {
  ...
  @ApiPropertyOptional({
    ...
    nullable: true,
    description:
      'Precio unitario override. Si est\u00e1 presente, manda sobre el margen para el c\u00e1lculo del precio. null = limpiar override.',
  })
  @IsOptional()
