...
4. Si el cambio es una adenda, insértala en la ubicación exacta indicada abajo (normalmente al final del cuerpo del ADR, antes de la sección `### Archivos`/`### Commits`/`### Pendientes` si existen, o si no al final del cuerpo, antes del encabezado `##` del siguiente ADR), sin alterar el texto previo del ADR.
